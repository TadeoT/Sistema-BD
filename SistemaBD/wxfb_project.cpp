...
Base_principal::Base_principal( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_busquedadCliente = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer15->Add( m_busquedadCliente, 1, wxALL|wxEXPAND, 5 );
	...
	m_busquedadProducto = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer16->Add( m_busquedadProducto, 1, wxALL|wxEXPAND, 5 );
...
Base_ModificarCliente::Base_ModificarCliente( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	AceptarCliente = new wxButton( this, wxID_ANY, wxT("Guardar"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer63->Add( AceptarCliente, 0, wxALL, 5 );
	
	CancelarCliente = new wxButton( this, wxID_ANY, wxT("Volver"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer63->Add( CancelarCliente, 0, wxALL, 5 );
...
Base_ModificarProducto::Base_ModificarProducto( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticText457 = new wxStaticText( this, wxID_ANY, wxT("Stock         "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText457->Wrap( -1 );
	bSizer817->Add( m_staticText457, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	Precio_prP = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer819->Add( Precio_prP, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	Precio_puP = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer8110->Add( Precio_puP, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	AceptarProducto = new wxButton( this, wxID_ANY, wxT("Guardar"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer103->Add( AceptarProducto, 0, wxALL, 5 );
	...
	// Connect Events
	AceptarProducto->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Base_ModificarProducto::ClickAceptarProducto ), NULL, this );
	CancelarProducto->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Base_ModificarProducto::ClickCancelarProducto ), NULL, this );
}

Base_ModificarProducto::~Base_ModificarProducto()
{
	// Disconnect Events
	AceptarProducto->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Base_ModificarProducto::ClickAceptarProducto ), NULL, this );
	CancelarProducto->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Base_ModificarProducto::ClickCancelarProducto ), NULL, this );
	
}

Base_AgregarPago::Base_AgregarPago( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	this->SetSizeHints( wxDefaultSize, wxDefaultSize );
	...
	m_staticText55 = new wxStaticText( this, wxID_ANY, wxT("DNI Cliente"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText55->Wrap( -1 );
	bSizer90->Add( m_staticText55, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	dniClientePago = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer90->Add( dniClientePago, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_staticText56 = new wxStaticText( this, wxID_ANY, wxT("Monto        "), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText56->Wrap( -1 );
	bSizer92->Add( m_staticText56, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	montoPago = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer92->Add( montoPago, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	
	bSizer89->Add( bSizer92, 1, wxEXPAND, 5 );
	
	wxBoxSizer* bSizer94;
	bSizer94 = new wxBoxSizer( wxHORIZONTAL );
	
	Aceptar = new wxButton( this, wxID_ANY, wxT("Realizar Pago"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer94->Add( Aceptar, 0, wxALL, 5 );
	
	m_button23 = new wxButton( this, wxID_ANY, wxT("Cancelar"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer94->Add( m_button23, 0, wxALL, 5 );
	
	
	bSizer89->Add( bSizer94, 0, wxALIGN_RIGHT, 5 );
	...
	// Connect Events
	Aceptar->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Base_AgregarPago::ClickAceptarPago ), NULL, this );
	m_button23->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Base_AgregarPago::ClickCancelarPago ), NULL, this );
}

Base_AgregarPago::~Base_AgregarPago()
{
	// Disconnect Events
